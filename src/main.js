                    ...
                    <div className="box">
                        <div>
                            ...
                            <div className="textBorder">
                                <p id="text1">
                                    <strong>
                                        Starke Marken – systemische Entwicklung
                                        und Führung, ganzheitliches
                    ...
                    <div className="box">
                        <div>
                            ...
                            <div className="textBorder">
                                <p id="text2">
                                    <strong>
                                        Gestalt im Management – Eine andere
                                        Sicht auf Marken- und
                                        Unternehmensführung in komplexen Märkten
                                    </strong>
                                    <br />
                                    <em>
                    ...
                    <div className="box">
                        <div>
                            ...
                            <div className="textBorder">
                                <p id="text3">
                                    <strong>
                                        Salomo Friedlaender/Mynona - Impulsgeber
                                        der Gestaltherapie / Balance, Nullpunkt,
                                        Schöpferische Indifferenz
                                    </strong>
                                    <br />
                                    Titel des eigenen Beitrags: „Einfach beim
                                    Wort nehmen“
                                    <em>
                                        Herausgeber Detlef Thiel / Kohlhage
                                        Verlag, Bergisch Gladbach, 2014
                                    </em>
                                    <br />
                                </p>
                            </div>
                        ...
                        <div>
                            ...
                            <div className="textBorder">
                                <p id="text4">
                                    ...
                                    <br />
                                    <em>
                                        Deutscher Wissenschafts-Verlag, Baden
                                        Baden, 2014 (erscheint in englischer
                                        Sprache in 2018)
                                    </em>
                                </p>
                            </div>
                        ...
                        <div>
                            ...
                            <div className="textBorder">
                                <p id="text5">
                                    ...
                                    <br />
                                    Mit Vorwörtern von Markus Hartung, Direktor
                        ...
                        <div>
                            ...
                            <div className="textBorder">
                                <p id="text6">
                                    ...
                                    <br />
                                    <em>
                                        Springer Gabler Verlag, Wiesbaden, März
                                        2018
                                    </em>
                                </p>
                            </div>
